...
void ConstructionResource::printImpl(std::ostream &os) const {
    os << "ConstructionResource(" << name
            ...
            << ", type=";
    switch (type) {
        case ConstructionType::Civ: os << "Civ";
            break;
        case ConstructionType::Mil: os << "Mil";
            break;
        case ConstructionType::Infra: os << "Infra";
            break;
        case ConstructionType::Dockyard: os << "Dockyard";
            break;
        case ConstructionType::Airfield: os << "Airfield";
            break;
        case ConstructionType::ArmyRF: os << "ArmyRF";
            break;
        case ConstructionType::NavalRF: os << "NavalRF";
            break;
        case ConstructionType::AerialRF: os << "AerialRF";
            break;
        case ConstructionType::NuclearRF: os << "NuclearRF";
            break;
    }
    os << ")";
}
